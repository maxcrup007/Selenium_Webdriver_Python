...
#     ทดสอบการเข้าใช้งานของ "ปลูก" (ทั้งหมดที่กรอกเป็นทศนิยมทั้งหมด)
...
class TestPlanting_27(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            plant.plant_enter_value("10.5")

            time.sleep(2)

            plant.plant_enter_area("10.5")
            ...
            plant.plant_enter_products("100.55")
            ...
            plant.plant_enter_paid("1500.75")

            time.sleep(2)

            plant.plant_enter_submit()
            # ทั้งหมดที่กรอกเป็นทศนิยมทั้งหมด
