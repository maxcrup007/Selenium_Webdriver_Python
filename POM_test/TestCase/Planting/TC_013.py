...
#     ทดสอบการเข้าใช้งานของ "ปลูก" (กรอกค่าใช้จ่ายเป็นอักษร)
...
class TestPlanting_13(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            plant.plant_enter_paid("one-thousand-five-hundred")
            # กรอกค่าใช้จ่ายเป็นอักษร
