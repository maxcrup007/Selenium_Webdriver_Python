...
#     ทดสอบการเข้าใช้งานของ "ปลูก" (ทั้งหมดที่กรอกเป็นศูนย์ทั้งหมด)
...
class TestPlanting_26(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            plant.plant_enter_value("0")

            time.sleep(2)

            plant.plant_enter_area("0")
            ...
            plant.plant_enter_paid("0")
            # ทั้งหมดที่กรอกเป็นศูนย์ทั้งหมด
