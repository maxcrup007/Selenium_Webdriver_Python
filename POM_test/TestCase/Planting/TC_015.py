...
#     ทดสอบการเข้าใช้งานของ "ปลูก" (กรอกประมาณการผลผลิดเป็นทศนิยม)
...
class TestPlanting_15(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            plant.plant_enter_products("100.755")
            # กรอกประมาณการผลผลิดเป็นทศนิยม
