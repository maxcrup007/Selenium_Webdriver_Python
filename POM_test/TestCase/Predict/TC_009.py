...
#     ทดสอบการเข้าใช้งานของ "ประเมิน" (กรอกจำนวนที่ประเมินเป็นเลขไทย)
...
class TestPredict_9(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            predict.predict_value_selected("๑๑๒")
            # กรอกจำนวนที่ประเมินเป็นเลขไทย
