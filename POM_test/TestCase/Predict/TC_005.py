...
#     ทดสอบการเข้าใช้งานของ "ประเมิน" (กรอกจำนวนที่ประเมินเป็นตัวอักษร)
...
class TestPredict_5(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            predict.predict_value_selected("one-hundred")
            # กรอกจำนวนที่ประเมินเป็นตัวอักษร
