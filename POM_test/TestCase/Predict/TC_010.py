...
#     ทดสอบการเข้าใช้งานของ "ประเมิน" (กรอกจำนวนที่ประเมินเป็นค่าติดลบ)
...
class TestPredict_10(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            predict.predict_value_selected("-100")
            # กรอกจำนวนที่ประเมินเป็นค่าติดลบ
