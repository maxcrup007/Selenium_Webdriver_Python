...
#     ทดสอบการเข้าใช้งานของ "เก็บเกี่ยว" (กรอกค่าใช้จ่ายเป็นทศนิยม)
...
class TestHarvest_14(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            harvest.harvest_paid_crops("1500.555")
            # กรอกค่าใช้จ่ายเป็นทศนิยม
