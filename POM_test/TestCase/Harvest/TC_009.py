...
#     ทดสอบการเข้าใช้งานของ "เก็บเกี่ยว" (กรอกจำนวนที่เก็บเกี่ยวเป็นเลขไทย)
...
class TestHarvest_9(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            harvest.harvest_value_crops("๑๑๒")
            # กรอกจำนวนที่เก็บเกี่ยวเป็นเลขไทย
