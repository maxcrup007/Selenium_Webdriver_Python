...
#     ทดสอบการเข้าใช้งานของ "เก็บเกี่ยว" (กรอกค่าใช้จ่ายไม่เท่ากับตอนประเมิน)
...
class TestHarvest_17(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            harvest.harvest_value_crops("100")
            ...
            harvest.harvest_paid_crops("15000000")
            # กรอกค่าใช้จ่ายไม่เท่ากับตอนประเมิน
