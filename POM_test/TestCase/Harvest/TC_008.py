...
#     ทดสอบการเข้าใช้งานของ "เก็บเกี่ยว" (กรอกจำนวนที่เก็บเกี่ยวเป็นทศนิยม)
...
class TestHarvest_8(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            harvest.harvest_value_crops("100.75")
            # กรอกจำนวนที่เก็บเกี่ยวเป็นทศนิยม
