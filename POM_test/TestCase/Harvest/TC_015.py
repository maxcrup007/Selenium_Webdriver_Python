...
#     ทดสอบการเข้าใช้งานของ "เก็บเกี่ยว" (กรอกค่าใช้จ่ายเป็นเลขไทย)
...
class TestHarvest_15(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            harvest.harvest_paid_crops("๑๕๙๙")
            # (กรอกค่าใช้จ่ายเป็นเลขไทย)
