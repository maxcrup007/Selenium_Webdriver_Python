...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกรหัสแปลงเป็นอักขระ)
...
class TestGarden_19(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-3").send_keys("%1003♦1$") # กรอกรหัสแปลงเป็นอักขระ
