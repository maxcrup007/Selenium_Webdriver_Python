...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกพื้นที่แปลงเป็นอักษร)
...
class TestGarden_20(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-7").send_keys("one-hundred") # กรอกพื้นที่แปลงเป็นอักษร
