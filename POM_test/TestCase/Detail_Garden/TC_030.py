...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกบ้านเลขที่เป็นตัวอักษร)
...
class TestGarden_30(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-5").send_keys("บ้านเลขที่ห้า") # กรอกบ้านเลขที่เป็นตัวอักษร
