...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (ทำรายการยกเว้น การเลือกกรรมสิทธิ์ที่ดิน)
...
class TestGarden_4(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            garden.garden_enter_district() # ทำรายการยกเว้น การเลือกกรรมสิทธิ์ที่ดิน
