...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกชื่อแปลงเป็นตัวเลขล้วน)
...
class TestGarden_14(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-2").send_keys("101011003") # กรอกชื่อแปลงเป็นตัวเลขล้วน
