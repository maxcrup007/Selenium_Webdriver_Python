...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกชื่อแปลงเป็นอักขระล้วน)
...
class TestGarden_15(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-2").send_keys("*#@$%&") # กรอกชื่อแปลงเป็นอักขระล้วน
