...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกชื่อแปลงและรหัสแปลงเป็นเลขศูนย์)
...
class TestGarden_34(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-2").send_keys("0")

            time.sleep(2)

            driver.find_element_by_name("ion-input-3").send_keys("0")
            ...
            driver.find_element_by_name("ion-input-5").send_keys("555") # กรอกชื่อแปลงและรหัสแปลงเป็นเลขศูนย์
