...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกรหัสแปลงเป็นตัวอักษร)
...
class TestGarden_18(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-3").send_keys("zero-two") # กรอกรหัสแปลงเป็นตัวอักษร
