...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (ทำรายการยกเว้น กรอกบ้านเลขที่)
...
class TestGarden_13(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-5").send_keys("") # ทำรายการยกเว้น กรอกบ้านเลขที่
