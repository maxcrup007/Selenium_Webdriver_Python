...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (ทำรายการเฉพาะ เลือกหน่วยพื้นที่แปลง)
...
class TestGarden_5(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-5").send_keys("555") # (ทำรายการเฉพาะ เลือกหน่วยพื้นที่แปลง)
