...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกบ้านเลขที่มีแต่เลขศูนย์)
...
class TestGarden_33(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-5").send_keys("000") # กรอกบ้านเลขที่มีแต่เลขศูนย์
