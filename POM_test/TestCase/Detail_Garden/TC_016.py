...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกชื่อแปลงเป็นอักษรสลับกับอักขระ)
...
class TestGarden_16(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-2").send_keys("♥แปลง@&eiei") # กรอกชื่อแปลงเป็นอักษรสลับกับอักขระ
