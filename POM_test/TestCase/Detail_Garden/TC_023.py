...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกพื้นที่แปลงเป็นเลขศูนย์)
...
class TestGarden_23(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-7").send_keys("0") # กรอกพื้นที่แปลงเป็นเลขศูนย์
