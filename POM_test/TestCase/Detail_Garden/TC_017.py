...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกชื่อแปลงเป็นเลขสลับกับอักขระ)
...
class TestGarden_17(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-2").send_keys("%1003♦1$") # กรอกชื่อแปลงเป็นเลขสลับกับอักขระ
