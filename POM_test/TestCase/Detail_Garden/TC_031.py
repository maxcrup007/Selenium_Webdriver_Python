...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกบ้านเลขที่เป็นอักขระ (ยกเว้น /))
...
class TestGarden_31(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-5").send_keys("#25\44@") # กรอกบ้านเลขที่เป็นอักขระ (ยกเว้น /)
