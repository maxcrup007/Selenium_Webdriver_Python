...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (ทำรายการยกเว้น กรอกชื่อแปลง)
...
class TestGarden_9(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            # driver.find_element_by_name("ion-input-2").send_keys("eiei") # ทำรายการยกเว้น กรอกชื่อแปลง
