...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกรหัสแปลงและบ้านเลขที่เป็นเลขศูนย์)
...
class TestGarden_35(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-3").send_keys("000")
            ...
            driver.find_element_by_name("ion-input-5").send_keys("000") # กรอกรหัสแปลงและบ้านเลขที่เป็นเลขศูนย์
