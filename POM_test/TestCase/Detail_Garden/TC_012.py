...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (ทำรายการยกเว้น กรอกรหัสไปรษณีย์)
...
class TestGarden_12(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-7").send_keys("4") # (ทำรายการยกเว้น กรอกรหัสไปรษณีย์)
