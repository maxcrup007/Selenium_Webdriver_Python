...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (ทำรายการยกเว้น การเลือกหน่วยแปลง)
...
class TestGarden_3(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-2").send_keys("eiei") # ทำรายการยกเว้น การเลือกหน่วยแปลง
