...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกบ้านเลขที่ที่ไม่มีอยู่จริง)
...
class TestGarden_32(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-5").send_keys("25/25/214") # กรอกบ้านเลขที่ที่ไม่มีอยู่จริง
