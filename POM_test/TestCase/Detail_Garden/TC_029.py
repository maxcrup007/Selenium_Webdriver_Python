...
#         ทดสอบการเข้าเพิ่มข้อมูลของ "แปลง" (กรอกรหัสไปรษณีย์ที่ไม่ตรงกับที่อยู่)
...
class TestGarden_29(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            driver.find_element_by_name("ion-input-5").send_keys("555") # กรอกรหัสไปรษณีย์ที่ไม่ตรงกับที่อยู่
