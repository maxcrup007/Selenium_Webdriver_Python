...
#     ทดสอบการเข้าใช้งานของ "ปัจจัย"  (แต่ไม่กรอกอะไรเลย)
...
class TestFactor_10(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            factor.factor_enter_name("") # แต่ไม่กรอกอะไรเลย

            time.sleep(2)

            factor.factor_enter_value("") # แต่ไม่กรอกอะไรเลย

            time.sleep(2)

            factor.factor_enter_price("") # แต่ไม่กรอกอะไรเลย

            time.sleep(2)

            factor.factor_enter_category()
