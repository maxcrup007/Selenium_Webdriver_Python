...
#     ทดสอบการเข้าใช้งานของ "ปัจจัย"  (กรอกชื่อเป็นตัวเลขและอักขฬะ)
...
class TestFactor_7(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            factor.factor_enter_name("@#$@&18415842") # กรอกชื่อเป็นตัวเลขและอักขฬะ
