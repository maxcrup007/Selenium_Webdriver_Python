...
#     ทดสอบการเข้าใช้งานของ "ขาย" (กรอกจำนวนและราคาขายเป็นเลขไทย)
...
class TestSelling_19(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            selling.selling_value_totally("๑๑๒")
            # กรอกจำนวนและราคาขายเป็นเลขไทย
            ...
            selling.selling_price_total("๑๕๙๙๙")
            # กรอกจำนวนและราคาขายเป็นเลขไทย
