...
#     ทดสอบการเข้าใช้งานของ "ขาย" (กรอกจำนวนและราคาขายเป็นค่าติดลบ)
...
class TestSelling_20(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            selling.selling_value_totally("-100")
            # กรอกจำนวนและราคาขายเป็นค่าติดลบ
            ...
            selling.selling_price_total("-15000")
            # กรอกจำนวนและราคาขายเป็นค่าติดลบ
