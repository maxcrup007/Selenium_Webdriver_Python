...
#     ทดสอบการเข้าใช้งานของ "ขาย" (กรอกจำนวนที่ขายเป็นทศนิยม)
...
class TestSelling_8(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            selling.selling_value_totally("100.755")
            # กรอกจำนวนที่ขายเป็นทศนิยม
