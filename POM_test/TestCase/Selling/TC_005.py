...
#     ทดสอบการเข้าใช้งานของ "ขาย" (กรอกจำนวนที่ขายเป็นตัวอักษร)
...
class TestSelling_5(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            selling.selling_value_totally("one-hundred")
            # กรอกจำนวนที่ขายเป็นตัวอักษร.
