...
#     ทดสอบการเข้าใช้งานของ "ขาย" (กรอกจำนวนและราคาขายให้เป็นศูนย์)
...
class TestSelling_17(unittest.TestCase):
        ...
        def test_login_valid(self):
            ...
            selling.selling_value_totally("0")
            # กรอกจำนวนและราคาขายให้เป็นศูนย์
